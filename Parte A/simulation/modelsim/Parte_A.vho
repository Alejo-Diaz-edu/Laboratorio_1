...
ENTITY 	FullAdder_BlockDiagram_Parte2 IS
    PORT (
	S : OUT std_logic;
	A : IN std_logic;
	B : IN std_logic;
...
END FullAdder_BlockDiagram_Parte2;
...
ARCHITECTURE structure OF FullAdder_BlockDiagram_Parte2 IS
...
-- Equation(s):
-- \inst|S~0_combout\ = \A~input_o\ $ (\B~input_o\ $ (\Cin~input_o\))
...
-- Equation(s):
-- \inst|Cout~0_combout\ = (\A~input_o\ & ((\B~input_o\) # (\Cin~input_o\))) # (!\A~input_o\ & (\B~input_o\ & \Cin~input_o\))
