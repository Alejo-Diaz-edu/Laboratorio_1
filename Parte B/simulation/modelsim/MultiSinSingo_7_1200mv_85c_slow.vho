...
SIGNAL \inst|AC~0_combout\ : std_logic;
...
-- Equation(s):
-- \inst3~0_combout\ = (\A0~input_o\ & \B0~input_o\)
...
\inst1|S\ : cycloneiii_lcell_comb
-- Equation(s):
-- \inst1|S~combout\ = (\B0~input_o\ & (\A1~input_o\ $ (((\B1~input_o\ & \A0~input_o\))))) # (!\B0~input_o\ & (\B1~input_o\ & (\A0~input_o\)))
...
\inst|S~0\ : cycloneiii_lcell_comb
-- Equation(s):
-- \inst|S~0_combout\ = (\B1~input_o\ & (\A1~input_o\ & ((!\A0~input_o\) # (!\B0~input_o\))))
...
\inst|AC~0\ : cycloneiii_lcell_comb
-- Equation(s):
-- \inst|AC~0_combout\ = (\B0~input_o\ & (\B1~input_o\ & (\A0~input_o\ & \A1~input_o\)))
